    ...
    <Box className='content-center'>
      <Card sx={{ zIndex: 1 }}>
        <CardContent sx={{ p: theme => `${theme.spacing(13, 7, 6.5)} !important` }}>
          ...
          >
            {/* <img
              src='/images/pages/visualee_logo (2) .png'
              alt='Description'
              style={{ marginLeft: '0px', marginRight: '0px', marginBottom: '70px', height: '50px', width: '60px' }}
            />
            <img
            ...
            {/* <div
              style={{
                backgroundImage: 'url(/images/pages/logo_white (1).png)',
            ...
            {/* <span style={{ width: '8px', height: '8px', borderRadius: '4px', backgroundColor: 'indigo' }}></span>
            </div> */}
          </Box>
